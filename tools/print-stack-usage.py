...
#  Usage:
#
#    $ ./tools/print-stack-usage.py kernel.elf | sort -n
#
import argparse
import subprocess
import os
...
def main():
    parser = argparse.ArgumentParser(description="Prints stack consumptions in the executable.")
    ...
    with tempfile.TemporaryDirectory() as tempdir:
        ...
        subprocess.run([os.environ.get("LLVM_PREFIX", "") + "llvm-objcopy", "-Obinary", "--dump-section", f".stack_sizes={stack_file}",
