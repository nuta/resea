...
proto.fields.process_add_pager_pager = ProtoField.int32("resea.payloads.process.add_pager.pager", "pager");
proto.fields.process_add_pager_start = ProtoField.uint64("resea.payloads.process.add_pager.start", "start");
proto.fields.process_add_pager_size = ProtoField.uint64("resea.payloads.process.add_pager.size", "size");
proto.fields.process_add_pager_flags = ProtoField.uint8("resea.payloads.process.add_pager.flags", "flags");
proto.fields.process_send_channel_proc = ProtoField.int32("resea.payloads.process.send_channel.proc", "proc");
proto.fields.thread_spawn_proc = ProtoField.int32("resea.payloads.thread.spawn.proc", "proc");
proto.fields.thread_spawn_start = ProtoField.uint64("resea.payloads.thread.spawn.start", "start");
proto.fields.thread_spawn_stack = ProtoField.uint64("resea.payloads.thread.spawn.stack", "stack");
proto.fields.thread_spawn_buffer = ProtoField.uint64("resea.payloads.thread.spawn.buffer", "buffer");
proto.fields.thread_spawn_arg = ProtoField.uint64("resea.payloads.thread.spawn.arg", "arg");
proto.fields.thread_destroy_thread = ProtoField.int32("resea.payloads.thread.destroy.thread", "thread");
proto.fields.timer_set_initial = ProtoField.int32("resea.payloads.timer.set.initial", "initial");
proto.fields.timer_set_interval = ProtoField.int32("resea.payloads.timer.set.interval", "interval");
proto.fields.timer_clear_timer = ProtoField.int32("resea.payloads.timer.clear.timer", "timer");
proto.fields.server_connect_interface = ProtoField.uint8("resea.payloads.server.connect.interface", "interface");
proto.fields.memory_alloc_pages_order = ProtoField.uint64("resea.payloads.memory.alloc_pages.order", "order");
proto.fields.memory_alloc_phy_pages_map_at = ProtoField.uint64("resea.payloads.memory.alloc_phy_pages.map_at", "map_at");
proto.fields.memory_alloc_phy_pages_order = ProtoField.uint64("resea.payloads.memory.alloc_phy_pages.order", "order");
proto.fields.pager_fill_proc = ProtoField.int32("resea.payloads.pager.fill.proc", "proc");
proto.fields.pager_fill_addr = ProtoField.uint64("resea.payloads.pager.fill.addr", "addr");
proto.fields.pager_fill_size = ProtoField.uint64("resea.payloads.pager.fill.size", "size");
