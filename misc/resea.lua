...
-- -----------------------------------------------------------------------------
-- Message definitions generated by gen-wireshark-defs.py
--
...
proto.fields.rand_add_randomness_randomness = ProtoField.uint32("resea.payloads.rand.add_randomness.randomness", "randomness" , base.DEC);
...
resea_messages = {
    ...
    [0x584] = {
        interface_name = "timer",
        name = "timer.uptime_reply",
        fields = {
            { name="uptime", proto=proto.fields.timer_uptime_reply_uptime, offset=32, len=8 },
        }
    },
    ...
    [0xa8d] = {
        interface_name = "kernel",
        name = "kernel.read_stats_reply",
        fields = {
            { name="uptime", proto=proto.fields.kernel_read_stats_reply_uptime, offset=32, len=8 },
            { name="ipc_total", proto=proto.fields.kernel_read_stats_reply_ipc_total, offset=40, len=8 },
            { name="page_fault_total", proto=proto.fields.kernel_read_stats_reply_page_fault_total, offset=48, len=8 },
            { name="context_switch_total", proto=proto.fields.kernel_read_stats_reply_context_switch_total, offset=56, len=8 },
            { name="kernel_call_total", proto=proto.fields.kernel_read_stats_reply_kernel_call_total, offset=64, len=8 },
        }
    },
    ...
    [0x2183] = {
        interface_name = "text_screen_device",
        name = "text_screen_device.clear_reply",
        fields = {
        }
    },
    ...
    [0x6381] = {
        interface_name = "rand",
        name = "rand.get_random_value_reply",
        fields = {
            { name="value", proto=proto.fields.rand_get_random_value_reply_value, offset=32, len=4 },
        }
    },
    
    [0x6302] = {
        interface_name = "rand",
        name = "rand.add_randomness",
        fields = {
            { name="randomness", proto=proto.fields.rand_add_randomness_randomness, offset=32, len=4 },
        }
    },
}
